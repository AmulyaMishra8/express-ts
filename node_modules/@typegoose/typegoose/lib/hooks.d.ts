...
export declare const pre: {
    ...
    <S_6 extends unknown, T_6 = S_6 extends Document<unknown, any, any, Record<string, any>> ? S_6 : HydratedDocument<DocumentType<S_6>, any>>(method: MongooseDistinctDocumentMiddleware | MongooseDistinctDocumentMiddleware[], fn: PreMiddlewareFunction<T_6>, options?: SchemaPreOptions): ClassDecorator;
    <S_7 extends unknown, T_7 = S_7 extends Document<unknown, any, any, Record<string, any>> ? S_7 : HydratedDocument<DocumentType<S_7>, any>>(method: MongooseQueryAndDocumentMiddleware | MongooseQueryAndDocumentMiddleware[] | RegExp, fn: PreMiddlewareFunction<T_7>, options?: SchemaPreOptions & {
        document: true;
    }): ClassDecorator;
    <S_8 extends unknown, T_8 = S_8 extends Document<unknown, any, any, Record<string, any>> ? S_8 : HydratedDocument<DocumentType<S_8>, any>>(method: MongooseQueryOrDocumentMiddleware | MongooseQueryOrDocumentMiddleware[] | RegExp, fn: PreMiddlewareFunction<T_8>, options?: SchemaPreOptions & {
        document: true;
        query: false;
    }): ClassDecorator;
...
export declare const post: {
    ...
    <S_11 extends unknown, T_12 = S_11 extends Query<any, any, {}, unknown, "find", Record<string, never>> ? S_11 : S_11 extends Document<unknown, any, any, Record<string, any>> ? S_11 : HydratedDocument<DocumentType<S_11>, any>>(method: MongooseQueryOrDocumentMiddleware | MongooseQueryOrDocumentMiddleware[] | RegExp, fn: ErrorHandlingMiddlewareFunction<T_12>, options?: SchemaPostOptions & {
        document: true;
        query: true;
    }): ClassDecorator;
